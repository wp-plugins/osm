...
class Osm_icon
{
 function getIconsize($a_IconName)
 {
   if (!strncmp($a_IconName, 'mic_', 4)){
     return array("height"=>37,"width"=>"32","offset_height"=>"-37","offset_width"=>"-16");
   }
     ...
     return array("height"=>23,"width"=>"32","offset_height"=>"-12","offset_width"=>"-16");
   }
     ...
     return array("height"=>19,"width"=>"32","offset_height"=>"-9","offset_width"=>"-16");
   }
     ...
     return array("height"=>18,"width"=>"32","offset_height"=>"-16","offset_width"=>"-9");
   }
