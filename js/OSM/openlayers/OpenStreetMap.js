...
OpenLayers.Layer.OSM.Mapnik = OpenLayers.Class(OpenLayers.Layer.OSM, {
    ...
    initialize: function(name, options) {
        ...
        options = OpenLayers.Util.extend({
            numZoomLevels: 20,
            attribution: "&copy; <a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> and <a href='http://mapicons.nicolasmollet.com/'>Icon</a> contributors; <a href='http://wp-osm-plugin.HanBlog.Net'>OSM Plugin</a>",
            buffer: 0,
...
OpenLayers.Layer.OSM.CycleMap = OpenLayers.Class(OpenLayers.Layer.OSM, {
    ...
    initialize: function(name, options) {
        ...
        options = OpenLayers.Util.extend({
            numZoomLevels: 19,
            attribution: "&copy; <a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> and <a href='http://mapicons.nicolasmollet.com/'>Icon</a>  contributors, Tiles courtesy of <a href='http://www.opencyclemap.org'>Andy Allan</a>; <a href='http://wp-osm-plugin.HanBlog.Net'>OSM Plugin</a>",
            buffer: 0,
            tileOptions: {crossOriginKeyword: null},
            transitionEffect: "resize"
        }, options);
